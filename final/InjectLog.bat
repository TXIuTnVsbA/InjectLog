...
xcopy InjectLog.smali /y .\projects\%inputgc%\Project\smali\com\hook\debuger\
...
del smalihook.py
pushd %current_dir%
xcopy InjectLog.smali /y .\projects\%inputgc%\Project\smali_classes2\com\hook\debuger\
goto done
